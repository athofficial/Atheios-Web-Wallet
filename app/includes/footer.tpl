<section class="pre-footer">
  <div class="container">
    <p>
      wallet.atheios.org does not hold your keys for you. We cannot access accounts, recover keys, reset passwords, nor reverse transactions. Protect your keys &amp; always check that you are on correct URL.
...
<footer class="footer" role="content" aria-label="footer" ng-controller='footerCtrl' >
  ...
  <article class="block__wrap" style="max-width: 1780px; margin: auto;">
    ...
    <section class="footer--righ" align="right">
      ...
      <div class="footer__pill-wrap">
          <a class="footer__pill"  aria-label="atheios.org" href="https://www.atheios.org" target="_blank" rel="noopener noreferrer">Website</a>
      </div>
      <div class="footer__pill-wrap">
          <a class="footer__pill"  aria-label="Atheios Block Explorer" href="https://explorer.atheios.org/" target="_blank" rel="noopener noreferrer">Explorer</a>
      </div>
      <div class="footer__pill-wrap">
          <a class="footer__pill"  aria-label="Join us on Discord!" href="https://discord.gg/8WmWj4T" target="_blank" rel="noopener noreferrer">Discord</a>
      </div>
      <div class="footer__pill-wrap">
      ...
      <!--
        ...
        <a aria-label="twitter" title="twitter" href="https://twitter.com/atheiosofficial" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="github" title="github" href="https://github.com/athofficial/" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="contact email" title="contact email" href="mailto:contact@atheios.org" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
